    ...
    <div className={`min-h-screen ${theme.pageBg}`}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-6">
        ...
        <section className={`${theme.cardBg} border ${theme.cardBorder} rounded-xl p-8`}>
          <h2 className={`text-xl font-bold ${theme.heading} mb-4`}>Open Source</h2>
          <p className={`${theme.muted} mb-6`}>
            The Dream API backend (plug-saas) is fully open source. Workers, D1 schema, SDK - all of it.
            Fork it, self-host it, learn from it.
          </p>
